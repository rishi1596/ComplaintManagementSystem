package rj.adminbkinfotech1.CustomDialogAdmin;
...
import rj.adminbkinfotech1.R;

public class CustomDialogBoxAdmin extends DialogFragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.custom_dialog_admin, container, false);
